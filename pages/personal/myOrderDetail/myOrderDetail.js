...
new getApp()), a = (t.getParams, {
    ...
    1: {
        1: {
            ...
            3: "请耐心等待工程师到达",
            4: "感谢您对小马维修的信任，专业的我们给您专业的服务",
            5: "感谢您对小马维修的信任，期待再次选择",
        ...
        2: {
            1: "感谢您对小马维修的信任，请根据维修中心地址邮寄",
            11: "感谢您对小马维修的信任，请根据维修中心地址邮寄",
            12: "感谢您对小马维修的信任，收件后我们会尽快维修",
            13: "感谢您对小马维修的信任，专业的我们给您专业的服务",
            2: "感谢您对小马维修的信任，专业的我们给您专业的服务",
            3: "感谢您对小马维修的信任，专业的我们给您专业的服务",
            4: "感谢您对小马维修的信任，专业的我们给您专业的服务",
            14: "感谢您对小马维修的信任，期待您的再次选择",
            15: "感谢您对小马维修的信任，期待您的再次选择",
            5: "感谢您对小马维修的信任，期待您的再次选择",
            0: "很抱歉没能给您提供服务，期待您的再次选择"
        },
        13: {
            1: "感谢您对小马维修的信任，请根据维修中心地址邮寄",
        ...
        3: {
            1: "感谢您对小马维修的信任，请根据中心地址前往",
            2: "感谢您对小马维修的信任，请根据中心地址前往",
            3: "感谢您对小马维修的信任，请根据中心地址前往",
            4: "感谢您对小马维修的信任，专业的我们给您专业的服务",
            5: "感谢您对小马维修的信任，期待再次选择",
            0: "很抱歉没能给您提供服务，期待您的再次选择"
        },
    ...
    3: {
        31: {
            ...
            2: "感谢您的耐心等待，稍后工程师会主动与您联系",
            3: "请耐心等待工程师到达",
            4: "感谢您对小马维修的信任，期待您的再次选择",
            5: "感谢您对小马维修的信任，期待您的再次选择",
            0: "很抱歉没能给您提供服务，期待您的再次选择"
        },
        32: {
            1: "感谢您对小马维修的信任",
            4: "感谢您对小马维修的信任，专业的工程师给您专业的服务",
            5: "感谢您对小马维修的信任",
            0: "感谢您对小马维修的信任，期待再次选择"
        }
    }
};
...
Page({
    ...
    getOrderDetail: function() {
        ...
        wx.showLoading(), e.getOrderDetail(n, this.data.type, this.data.order_id, this.data.order_sn, function(e) {
            ...
            e.order_type && !e.fault_info.length ? (s.setData({
                isOneKeyOrder: !0
            }), 1 == e.status ? (e.statusName = "下单成功，正在为您确认故障", e.statusTip = "感谢您对小马维修的信任，客服会在2小时内给您来电") : 0 == e.status && (e.statusName = "订单已取消", 
            ...
            if (e.assess_info && e.assess_info.equal.length) {
                var o = e.assess_info.equal.length;
                r.setData({
                    swiperHeight: 96 * o + "rpx"
                });
            }
            s.setData({
    ...
    makePhonecall: function(t) {
        if ("1" == t.currentTarget.dataset.shield) return wx.showLoading({
            title: "请稍等",
            mask: !0
        }), void e.phoneSheild(t.currentTarget.dataset.tel, function(e) {
