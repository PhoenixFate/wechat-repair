...
Page({
    ...
    chooseWay: function(t) {
        if (console.log(t), t.currentTarget.dataset.active) {
            var e = t.currentTarget.dataset.txt, i = t.currentTarget.dataset.category;
            this.setData({
                wayIschoose: !0,
                wayChoosedTxt: e,
                category: i
    ...
    getMemoryUp: function(e, i) {
        var a = this;
        t.getMemoryUp.call(a, function(t) {
            a.setData({
                modelAttr: t,
                faults: t[0].faults
            });
    ...
    modelChange: function(t) {
        var e = t.detail.value, i = this.data.modelValues;
        if (e[0] == i[0]) if (e[1] == i[1]) this.clearCoupon(); else {
            console.log("升级类型 改变 ");
            a = this.data.modelAttr[e[0]].model_name + "/" + this.data.modelAttr[e[0]].faults[e[1]].fault_detail_name;
            this.setData({
            ...
            var a = this.data.modelAttr[e[0]].model_name + "/" + this.data.modelAttr[e[0]].faults[0].fault_detail_name;
            this.setData({
                faults: this.data.modelAttr[e[0]].faults,
                modelChoosedTxt: a,
                modelIschoose: !0,
    ...
    getCreateOrder: function() {
        ...
        console.log(a);
        var s = e.globalData.hwxUserInfo.token;
        console.log(a), t.getCreateOrder.call(i, s, a, function(t) {
    ...
    goToCoupon: function() {
        if (this.data.noDefaultAddress) wx.showToast({
            ...
            t.city = this.data.defaultAddress.city_id, t.district = this.data.defaultAddress.district_id) : 3 == this.data.category ? (t.city = this.data.centerList[this.data.centerIndex].city, 
    ...
    getDefaultAddress: function(i) {
        var a = this, s = e.globalData.hwxUserInfo.token;
        t.getDefaultAddress.call(a, s, function(t) {
    ...
    getCityPrice: function(e) {
        var i = this;
        t.getCityPrice.call(i, e, function(t) {
